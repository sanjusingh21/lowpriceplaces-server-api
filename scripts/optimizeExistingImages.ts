...
async function migratePath(relativeOrAbsolutePath: string): Promise<string> {
...
async function migrateListingImages(): Promise<void> {
...
async function migrateStoreImages(): Promise<void> {
...
async function migrateCategoryImages(): Promise<void> {
...
async function migrateCityImages(): Promise<void> {
